...
y = train[['label','is_eat','label_label']]
...
#XGboost开工
d_test = xgb.DMatrix(X_test_after_eat_healthy)
d_train = xgb.DMatrix( X_train_after_eat_healthy, label=y_train_after_eat_healthy)
...
y_test = np.array(y_test_after_eat_healthy)
y_test.tolist()
